...
class EyelinerStyleViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//        self.present(detailViewController, animated: false)
    ...
    @IBAction func btnChangeStyle(_ sender: UIButton) {
        let detailViewController:EyelinerViewController = self.storyboard!.instantiateViewController(withIdentifier: "EyelinerViewController") as! EyelinerViewController
        detailViewController.eyelinerStyleCV?.alpha = 1
    }
